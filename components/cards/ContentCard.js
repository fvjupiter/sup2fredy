...
export default function ContentCard({ title, date, intro, markdownContent, borderColor, bgColor, textOrientation, lgWidth }) {
    ...
    return <div className='px-1.5 noselect'>
        <div className={`mx-auto whitespace-pre-line ${lgWidth}
            ...
            <div className={`py-2 sm:py-4 px-2 sm:px-6 mx-auto 
                ${textOrientation} font-light
                bg-opacity-60 ${bgColor ? bgColor : 'bg-black'} 
                ring-4 border sm:border-2 ${borderColor ? borderColor : 'border-white'}
