    ...
    <>
      ...
      {isRandom && (
        <Link
          href={`${param2}/${
            slugList[param2][
              Math.floor(Math.random() * slugList[param2].length)
            ]
          }`}
        >
          <div
            className={`w-fit mx-auto text-center textShadow opacity-80 hover:opacity-100 text-white duration-300 cursor-pointer text-xl mb-2 sm:mt-3`}
          >
